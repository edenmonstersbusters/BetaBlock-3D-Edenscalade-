...
import { Layers, CheckCircle, RefreshCw, Scaling, RotateCw, Trash2 } from 'lucide-react';
...
export const HoldInspector: React.FC<HoldInspectorProps> = ({ 
  selectedHolds, onUpdate, onRemove, onDeselect, onToggleReplaceMode, isReplacingMode, onActionStart 
}) => {
  ...
  return (
    <section className="space-y-4 animate-in slide-in-from-right duration-300">
        ...
        <div className={`bg-gray-800 p-4 rounded-xl space-y-5 border ${isMulti ? 'border-emerald-500/30 bg-emerald-950/5' : 'border-blue-500/30'}`}>
