    ...
    return (
        <header className="relative py-24 px-6 border-b border-white/10 overflow-hidden shrink-0">
            ...
            <div className="max-w-7xl mx-auto relative z-10 text-center">
                <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6">{t('hero.title')} <span className="text-blue-500">Hub</span></h1>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    {user && (
                        ...
                        >
                            <LayoutGrid size={20} />
                            <span>{t('hero.my_private_walls')}</span>
                        </button>
                    )}
                </div>
            </div>
